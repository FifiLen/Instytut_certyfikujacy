const courses = [
...

  {
    "id": "asystent_vr",
    "title": "Asystent VR",
    "subtitle": "Przewodnik po świecie wirtualnej rzeczywistości",
    "description": "Asystent VR to innowacyjne narzędzie wykorzystujące technologie wirtualnej rzeczywistości do wsparcia użytkowników w codziennych zadaniach, edukacji, terapii oraz rozwoju osobistym. Program jest skierowany do szerokiego grona odbiorców, w tym do profesjonalistów z różnych branż, studentów oraz entuzjastów VR, którzy chcą zgłębić możliwości tej technologii.",
    "duration": "3 miesiące",
    "mode": "Online",
    "price": "2500zł",
    "points": [
    ...
    "outcomes": [
      ...
      "Wiedza na temat zastosowań VR w różnych dziedzinach",
      "Zdolność do efektywnego wykorzystania VR w pracy i życiu codziennym"
    ],
    "testimonials": [
      {
        "name": "Katarzyna Nowak",
        "text": "Program Asystent VR zaoferował mi kompleksowe wprowadzenie do świata VR. Jego elastyczność i praktyczne zadania bardzo mi odpowiadały."
      },
      {
